...
class Spider < Monster
  ...
  def self.types
    ...
    result[:sarqin] = { :name => "Sarqin, the Mother-of-All", :attribute_level => 8, :size => 3, :endurance => 90, :hate => 8, :parry => 5, :armor => 3, :shield => 0, :weapons => [{ :type=>:attribute_beak,:skill => 4}, {:type=>:ensnare,:skill => 3}], :abilities => [:great_size, :thick_hide, :seize_victim, :thing_of_terror, :foul_reek, :countless_children ]}
    result[:tauler] = { :name => "Tauler, the Hunter", :attribute_level => 7, :size => 3, :endurance => 60, :hate => 8, :parry => 8, :armor => 3, :shield => 0, :weapons => [{ :type=>:attribute_beak,:skill => 5}, {:type=>:stomp,:skill => 3 }], :abilities => [:great_size, :horrible_strength, :hideous_toughness, :strike_fear] }
    result[:tyulqin] = { :name => "Tyulqin, the Weaver", :attribute_level => 9, :size => 3, :endurance => 60, :hate => 8, :parry => 7, :armor => 3, :weapons => [{ :type=>:attribute_beak,:skill => 4}, {:type=>:ensnare,:skill => 3}], :abilities => [:great_size, :seize_victim, :strike_fear, :dreadful_spells, :webs_of_illusion, :many_poisons]}
